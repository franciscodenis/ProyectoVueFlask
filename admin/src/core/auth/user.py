...
user_has_roles = db.Table(
    ...
    db.Column(
        "institution_id", db.Integer, db.ForeignKey("institutions.id"), primary_key=True
    ),
    db.Column("role_id", db.Integer, db.ForeignKey("roles.id"), primary_key=True),
)

user_has_system_roles = db.Table(
    "user_has_system_roles",
    db.Column("user_id", db.Integer, db.ForeignKey("users.id"), primary_key=True),
    db.Column("role_id", db.Integer, db.ForeignKey("roles.id"), primary_key=True),
)
...
class User(db.Model):
    ...
    system_roles = db.relationship(
        "Role",
        secondary=user_has_system_roles,
        lazy=True,
